...
function getHGALogic() {
  return {
    ...
    calculateDistance(genome) {
      ...
      // Debug logging (only once per evaluation to avoid spam, or just rely on user checking console)
      // console.log(`Problem: ${this.problemId}, isMSTSP: ${isMSTSP}, Penalty: ${isMSTSP ? 100000 : 0}`);
